...
if($("#mainb").length)echarts.init(document.getElementById("mainb"),e).
setOption({title:{text:"PJES",subtext:"Oficiais"},tooltip:{trigger:"axis"},legend:{data:["Previsto","Executado"]},toolbox:{show:!1},calculable:!1,xAxis:[{type:"category",data:["JAN","FEV","MAR","ABR","MAI","JUN","JUL","AGO","SET","OUT","NOV","DEZ"]}],yAxis:[{type:"value"}],series:[
    
    {name:"Previsto",type:"bar",data:[2510,2510,2510,2510,2510,2510,2510,2510,2510,2510,2510,2510],
    markLine:{data:[{type:"max",name:"Teto"}]}},
    
    {name:"Executado",type:"bar",data:[2410,2410,2410,2410,2410,2410,0,0,0,0,0,0],
    markLine:{data:[{type:"max",name:"Teto"}]}}
    
    ]});

    if($("#mainbprc").length)echarts.init(document.getElementById("mainbprc"),e).
setOption({title:{subtext:"Praças"},tooltip:{trigger:"axis"},toolbox:{show:!1},calculable:!1,xAxis:[{type:"category",data:["JAN","FEV","MAR","ABR","MAI","JUN","JUL","AGO","SET","OUT","NOV","DEZ"]}],yAxis:[{type:"value"}],series:[
    
    {name:"Previsto",type:"bar",data:[19348,19348,19348,19348,19348,19348,19348,19348,19348,19348,19348,19348],
    markLine:{data:[{type:"max",name:"Teto"}]}},
    
    {name:"Executado",type:"bar",data:[17999,18122,17922,19045,20883,19348,0,0,0,0,0,0],
    markLine:{data:[{type:"max",name:"Teto"}]}}
