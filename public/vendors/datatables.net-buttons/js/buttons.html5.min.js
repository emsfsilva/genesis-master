...
style:"tableHeader"}}));for(var e=0,h=a.body.length;e<h;e++)f.push(g.map(a.body[e],function(a){return{text:"string"===typeof a?a:a+"",style:e%2?"tableBodyEven":"tableBodyOdd"}}));c.footer&&a.footer&&f.push(g.map(a.footer,function(a){return{text:"string"===typeof a?a:a+"",style:"tableFooter"}}));a={pageSize:c.pageSize,pageOrientation:c.orientation,content:[{table:{headerRows:1,body:f},layout:"noBorders"}],

footer: function(currentPage, pageCount) {
    return {
        columns: [
            { text: 'Data: ' + new Date().toLocaleDateString() + ' Hora: ' + new Date().toLocaleTimeString(), alignment: 'right', fontSize: 8, margin: [0, 0, 20, 0] }
        ]
    };
},
background: [
    {
        text: 'POLICIA MILITAR DE PERNAMBUCO',
        opacity: 0.5, // Opacidade da imagem
        fontSize: 30,
        alignment: 'center',
        margin: [20, 300, 20, 20] // margem inferior
    }
        ],
styles:{tableHeader:{bold:!0,fontSize:9,color:"white",fillColor:"#2d4154",alignment:"center"},
tableBodyEven:{},tableBodyOdd:{fillColor:"#f3f3f3"},tableFooter:{bold:!0,fontSize:9,color:"white",fillColor:"#2d4154"},title:{alignment:"center",fontSize:15},message:{}},defaultStyle:{fontSize:10}};c.message&&a.content.unshift({text:"function"==typeof c.message?c.message(b,d,c):c.message,style:"message",margin:[0,0,0,12]});c.title&&a.content.unshift({text:R(c,!1),style:"title",margin:[0,0,0,12]})

if (c.title){
    a.content.unshift({text: "Escala de Serviço" + (c.title || "*"),
    style: "title", margin: [0, 0, 0, 12]});
};
c.customize&&c.customize(a,c);b=(u||i.pdfMake).createPdf(a);"open"===c.download&&!M()?b.open():b.getBuffer(function(a){a=
new Blob([a],{type:"application/pdf"});q(a,x(c))})},title:"*",filename:"*",extension:".pdf",exportOptions:{},orientation:"landscape",pageSize:"A4",
header:!0,footer:!1,message:null,customize:null,download:"download"};return r.Buttons}
